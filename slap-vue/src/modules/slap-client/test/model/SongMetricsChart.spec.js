...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlapClient.SongMetricsChart();
  });
  ...
  describe('SongMetricsChart', function() {
    it('should create an instance of SongMetricsChart', function() {
      // uncomment below and update the code to test SongMetricsChart
      //var instane = new SlapClient.SongMetricsChart();
      //expect(instance).to.be.a(SlapClient.SongMetricsChart);
    });
