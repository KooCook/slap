...
from app_v2.serializers import SongSerializer, GenreSerializer, WordOccurrenceSerializer, ArtistSerializer
...
class WordView(APIView):
    ...
    def get(self, request, song_id: str):
        ...
        return Response({'words': s.genius_song.words})
