...
from app_v2.models import Artist, YoutubeVideo, ArtistSong, WordSong
...
def chain_kpop_songs(limit: int = 1000):
    ...
    for record in records[:limit]:
        ...
        try:
            ...
            ArtistSong.upsert(song=s, artist=Artist.get(first))
            vid = record['video_id']
...
def update_word_cache():
    WordSong.update_all_songs_word_frequency()
